    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtube.com/Renaldy Rotty')
                time.sleep(2)
                menu()
